...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow  relative ">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center mt-2.5 mb-5">
            ...
            <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 d ml-3">5.0</span>
        </div>
        <div class="flex items-center justify-between">
			...
			<div class="mb-1   space-x-2">
				...
				<a href={`/products/update/${product.id}`} class=""
					><Icon class="absolute  top-0 right-0" icon="material-symbols:edit" color="blue" width="40" height="40" /></a
				>
			</div>
         </div>
    </div>
